...
object Profile extends DelvingController {
  ...
  def profile(user: String): AnyRef = {
    ...
    Template('user -> u, 'objects -> objects, 'objectsCount -> objectsPage._2, 'collections -> collections, 'collectionsCount -> collectionsPage._2, 'stories -> stories, 'storiesPage -> collectionsPage._2, 'isVisible -> (u.userProfile.isPublic || isConnected))
  }
}
