  ...
  */
  def crumble(p: java.util.Map[String, java.util.Map[String, String]]): List[((String, String), Int)] = {
    ...
    val crumbs = crumbList match {
      ...
      case "organizations" :: orgName :: "site" :: "upload" :: Nil =>  List(("NOLINK", &("thing.organizations")), ("/organizations/" + orgName, orgName), ("/organizations/" + orgName + "/site", &("org.cms")), ("NOLINK", &("org.cms.upload")))
