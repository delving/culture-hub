 ...
 * Images utils
 *
 * Copied verbatim from Play 1 sources. We need this mainly for the captcha
 */
public class Images {
    ...
    public static String toBase64(File image) throws IOException {
        return "data:" + MimeTypes.forFileName(image.getName()) + ";base64," + MissingLibs.encodeBASE64(image);
    }
