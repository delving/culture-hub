...
thing.objects.user.info=Gebruikersobjecten zijn de dingen die wij in bezit hebben, maar die nog niet bekend zijn bij de erfgoed instanties.  Misschien oude foto's gevonden op zolder, of nieuwe foto's of opnames van objecten die de wereld zou moeten zien. Wij kunnen deze dingen nu online zetten en verzamelingen maken uit mengsels van objecten uit hun collecties en de onze, en verhalen schrijven die alles in context plaatsten.
thing.object.heritage=Erfgoedobject
thing.objects.heritage=Erfgoedobjecten
thing.objects.heritage.info=Erfgoedobjecten komen uit rijke verzamelingen waarvoor diverse erfgoed instanties verantwoordelijkheid dragen, en die door de organisaties zelf worden bijgehouden. Op deze site kunnen wij erfgoed objecten gebruiken als een beginpunt, en wellicht als inspiratiebron, en wij kunnen eruit kiezen om ons eigen verzamelingen en verhalen te bouwen.
thing.collection=Verzameling
thing.collections=Verzamelingen
thing.collections.info=Iedereen heeft zijn of haar favoriete onderwerpen, en deze site bied mogelijkheden om erfgoedobjecten te vinden en in facetten te navigeren, maar wij kunnen ook gevonden schatten slepen naar ons eigen verzamelingen.  Een collectie die wij maken en online zetten wordt geplaatst onder een unieke URL die wij makkelijk kunnen doorgeven aan anderen.
thing.story=Verhaal
thing.stories=Verhalen
thing.stories.info=Het verzinnen van een meeslepend rode draad is soms de enige manier om erfgoedobjecten de context die ze verdienen.  Vaak zijn de bijbehorende beschrijvingen onbevredigend, en objecten opnemen in een verhaal, zelfs aangevuld met ons eigen schatten, zou beter zijn.  Deze site vereenvoudigd het maken en publiceren van verhalen online voor alle geïnteresseerden.
...
thing.description=Beschrijving
thing.name=Naam
thing.title=Titel
thing.action=Actie
...
profile.activesince=Actief sinds

##Registration
registration.lostpassword=Wachtwoord vergeten
...
metadata.dc.provider=Aanbieder
...
registration.duplicateEmail=There is already a user with this email address
registration.duplicateDisplayName=There is already a user with this user name
registration.errorCreating=Error creating your account, please try again
registration.accountNotFoundWithEmail=No account could be found with this email address
registration.accountNotActive=This account is not active yet. Please activate your account with the link sent in the registration e-mail
