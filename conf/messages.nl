...
thing.objects.user=Gebruiker objecten
thing.objects.user.info=Dit zijn objecten geplaatst door onze gebruikers. Dit is een omgeving waar je niet alleen voor dingen kunt zoekn, maar ook dingen achter laten.
thing.objects.heritage=Erfgoed objecten
thing.objects.heritage.info=Dit zijn objecten uit de collecties van cultureel erfgoed instellingen.
thing.collection=Collectie
thing.collections=Collecties
thing.collections.info=Collecties zijn een aantal objecten in een groep.
thing.story=Verhaal
thing.stories=Verhalen
thing.stories.info=Verhalen worden opgebouwd uit objecten en teksten.  Verhalen zijn een mooie manier om meer mening en context aan een digitaal object te geven.
...
metadataeuropeana.type=Type
metadata.europeana.year=Jaar
metadataicn.acquisitionMeans=Wijze van verwerving
metadata.icn.acquisitionYear=Jaar van verwerving
metadata.icn.acquiredWithHelpFrom=Verworven met steun van
metadataicn.collectionPart=Deelcollectie
metadata.icn.collection=Collectie
metadataicn.creatorYearOfBirth=Vervaardiger geboortejaar
metadataicn.location=Locatie
