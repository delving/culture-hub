...
thing.objects.user.info=Gebruikersobjecten zijn de dingen die wij in bezit hebben, maar die nog niet bekend zijn bij de erfgoed instanties.  Misschien oude foto's gevonden op zolder, of nieuwe foto's of opnames van objecten die de wereld zou moeten zien. Wij kunnen deze dingen nu online zetten en collecties maken uit mengsels van objecten uit hun collecties en de onze, en verhalen schrijven die alles in context plaatsten.
thing.object.heritage=Erfgoedobject
thing.objects.heritage=Erfgoedobjecten
thing.objects.heritage.info=Erfgoedobjecten komen uit rijke collecties waarvoor diverse erfgoed instanties verantwoordelijkheid dragen, en die door de organisaties zelf worden bijgehouden. Op deze site kunnen wij erfgoed objecten gebruiken als een beginpunt, en wellicht als inspiratiebron, en wij kunnen eruit kiezen om ons eigen collecties en verhalen te bouwen.
...
metadata.tib.productionStart=Begin Productie
metadata.tib.productionEnd=Einde Productie
