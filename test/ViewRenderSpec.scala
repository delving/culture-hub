      ...
      withTestConfig {
        ...
        val expected: String =
          ...
          """<div class="root ">
            ...
            |<h5>md.icn.purchaseType </h5>            <p>auction</p>
            |<p><a href="http://foo.bar.com" data-type="" rel="nofollow">Blablabla</a></p>
            |</div>
            |</div>
            |<div class="column ">
            |<div  >
            |<h5>md.icn.placeName </h5>            <p>Paris</p>
            |<h5>md.icn.placeName </h5>            <p>Berlin</p>
            |<h5>md.icn.placeName </h5>            <p>Amsterdam</p>
            |</div>
            |</div>
            |</div>
            |</div>
      ...
      <row>
        ...
        <column id="fields">
          <container>
            ...
            <field path="/record/icn:data/icn:acquisition/@type" label="md.icn.purchaseType"/>
        ...
        <column id="complexFields">
          <container>
            <list path="/record/icn:places/icn:place">
              <field path="@name" label="md.icn.placeName"/>
            </list>
          </container>
        </column>
      </row>
