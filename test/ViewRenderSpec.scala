      ...
      withTestConfig {
        ...
        val expected: String =
          ...
          """<div class="root ">
            ...
            |<h5>_md.icn.purchaseType </h5>            <p>auction</p>
            |<p><a href="http://foo.bar.com" data-type="" rel="nofollow">Blablabla</a></p>
            |</div>
            |</div>
            |<div class="column ">
            |<div  >
            |<h5>_md.icn.placeName </h5>            <p>Paris</p>
            |<h5>_md.icn.placeName </h5>            <p>Berlin</p>
            |<h5>_md.icn.placeName </h5>            <p>Amsterdam</p>
            |</div>
            |</div>
            |</div>
            |</div>
    ...
    <view name="full">
      <row>
        <column id="description">
          <container>
            <field path="/record/delving:summaryFields/delving:description" label="md.dc.description"/>
          </container>
        </column>
        <column id="fields">
          <container>
            ...
            <field path="/record/icn:data/icn:acquisition/icn:cost" label="md.icn.purchasePrice" role="administrator, own"/>
            <field path="/record/icn:data/icn:acquisition/@type" label="_md.icn.purchaseType"/>
        ...
        <column id="complexFields">
          <container>
            <list path="/record/icn:places/icn:place">
              <field path="@name" label="_md.icn.placeName"/>
            </list>
          </container>
        </column>
      </row>
